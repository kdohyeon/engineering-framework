...
X  - 연도 기준, 매년 1회 auto-increment  (예: 2026년 → 1, 2027년 → 2)
Y  - 정기 릴리즈마다 increment           (예: 1월 릴리즈 → .1, 2월 → .2)
Z  - 핫픽스 / 버그픽스 등 세부 배포      (예: 긴급 패치 → .1, .2, ...)
```

**예시 흐름:**

```
v1.1.0  - 2026년 1월 정기 릴리즈
v1.1.1  - 1월 릴리즈 후 핫픽스
v1.2.0  - 2026년 2월 정기 릴리즈
v1.3.0  - 2026년 3월 정기 릴리즈
  ...
v1.12.0 - 2026년 12월 정기 릴리즈
v2.1.0  - 2027년 1월 정기 릴리즈  ← X 증가
```
