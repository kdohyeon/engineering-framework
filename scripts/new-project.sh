...
echo "✅ .github/workflows/notify-slack.yml"

# docs 폴더
mkdir -p "$TARGET_DIR/docs/prd"
mkdir -p "$TARGET_DIR/docs/decisions"
echo "✅ docs/prd/ 폴더 생성"
echo "✅ docs/decisions/ 폴더 생성"
...
echo ""
echo "1. PRD 작성:"
echo "   cp $FRAMEWORK_DIR/templates/PRD_TEMPLATE.md $TARGET_DIR/docs/prd/v1.0.md"
echo ""
echo "2. GitHub repo 생성 후 push"
echo ""
echo "3. GitHub Secrets 설정:"
echo "   - SLACK_WEBHOOK_URL"
echo ""
echo "4. GitHub Issues 레이블 추가:"
echo "   feature / bug / hotfix / chore / docs"
echo ""
echo "5. GitHub Milestone 생성: v1.0.0"
